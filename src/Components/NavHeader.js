...
const NavHeader = () => {
   return(
        ...
        <>
           ...
           <img className='me-auto' src='SWO_logo.png' width={250} />
                <span className='mx-auto'>Welcome to the Skill Matrix</span>
                <div className='ms-auto'>
                    <a><img className='nav-item' src='MyAccount.png' width={50} /></a>
                    <a><img className='nav-item' src='Search.png' width={50} /></a>
                    <a><img className='nav-item' src='LogOut.png' width={50} /></a>
                </div>
           </nav>
        </>
        );
