        ...
        <>
            <Navbar className='navbar navbar-light bg-light' data-testid='navbar'>
                <div className="container-fluid">
                    ...
                    <div className='ms-auto mx-4 px-4' data-testid='button-div'>
                        {this.state.isMyAccountEnabled && 
                        <a className='text-black' href='/' style={{textDecoration:'none'}} >
                            <img className='nav-item' src='MyAccount.png' width={50} alt= 'MyAccount' />
                            My Account</a>}
                        {this.state.isSearchEnabled && 
                        <a className='text-black' href='/' style={{textDecoration:'none'}} >
                            <img className='nav-item' src='Search.png'  width={50} alt= 'Search'/>
                            Search</a>}
                        {this.state.isLogoutEnabled && 
                        <a className='text-black' href='/' style={{textDecoration:'none'}} >
                            <img className='nav-item' src='LogOut.png' width={50} alt= 'LogOut'/>
                            Logout</a>}
                    </div>
                </div>
            </Navbar>
