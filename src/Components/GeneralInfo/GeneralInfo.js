           ...
           <Container fluid data-testid="general-info" className="mb-5 mt-3">
            ...
            <Form>
                ...
                <Row className="mb-3 ">
                    ...
                    <Form.Group as={Col} controlId="formGridTeam" className="text-start" xs={6} sm={{span:6, order:3}} md={{span:4, order:4}}>
                        <Form.Label data-testid="tTitle-label">Team</Form.Label>
                    <Form.Control type="team" placeholder="Enter Team Name" />
                    </Form.Group>


                    <Form.Group as={Col} controlId="formGridLast" className="text-start" xs={6} sm={{span:6, order:4}} md={{span:4, order:5}}>
